...
object MaterialLoader {
    ...
    private fun loadData(dir: File) {
        // Load materials as MaterialData and then configure them all
    ...
    */
    ...
    private fun getMaterialList(dir: File): MutableList<MaterialData> {

        val statList = mutableListOf<MaterialData>()
        val gson = Gson()
    ...
    // Given a file, return it's parsed data
    private fun getStatsFromFile(gson: Gson, file: File): MaterialData? {
        return try {
