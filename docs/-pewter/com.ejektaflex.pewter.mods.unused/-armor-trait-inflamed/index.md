[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.unused](../index.md) / [ArmorTraitInflamed](./index.md)

# ArmorTraitInflamed

`class ArmorTraitInflamed : `[`PewterArmorTrait`](../../com.ejektaflex.pewter.api.core.traits/-pewter-armor-trait/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ArmorTraitInflamed()` |
