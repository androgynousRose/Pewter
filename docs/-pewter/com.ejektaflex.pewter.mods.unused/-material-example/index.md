[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.unused](../index.md) / [MaterialExample](./index.md)

# MaterialExample

`class MaterialExample : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialExample()` |
