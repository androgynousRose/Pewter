[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.unused](../index.md) / [ToolModStick](./index.md)

# ToolModStick

`class ToolModStick : `[`PewterToolModifier`](../../com.ejektaflex.pewter.api.core.modifiers/-pewter-tool-modifier/index.md)`, `[`TinkerNBTHelper`](../../com.ejektaflex.pewter.lib.mixins/-tinker-n-b-t-helper/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ToolModStick()` |
