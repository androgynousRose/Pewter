[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.unused](../index.md) / [MaterialAlchemicalBrass](./index.md)

# MaterialAlchemicalBrass

`class MaterialAlchemicalBrass : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialAlchemicalBrass()` |
