[Pewter](../../index.md) / [com.ejektaflex.pewter.modules.other](../index.md) / [ModuleUnused](./index.md)

# ModuleUnused

`class ModuleUnused : `[`PewterModule`](../../com.ejektaflex.pewter.api.core/-pewter-module/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ModuleUnused()` |
