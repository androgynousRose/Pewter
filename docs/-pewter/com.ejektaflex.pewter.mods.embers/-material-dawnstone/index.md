[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.embers](../index.md) / [MaterialDawnstone](./index.md)

# MaterialDawnstone

`class MaterialDawnstone : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialDawnstone(matName: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
