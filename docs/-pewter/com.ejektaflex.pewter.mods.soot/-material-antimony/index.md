[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.soot](../index.md) / [MaterialAntimony](./index.md)

# MaterialAntimony

`class MaterialAntimony : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialAntimony(matName: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
