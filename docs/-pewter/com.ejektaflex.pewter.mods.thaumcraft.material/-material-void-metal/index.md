[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.thaumcraft.material](../index.md) / [MaterialVoidMetal](./index.md)

# MaterialVoidMetal

`class MaterialVoidMetal : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialVoidMetal(name: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
