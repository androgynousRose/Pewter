[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.betterwithmods](../index.md) / [MaterialSoulforgedSteel](./index.md)

# MaterialSoulforgedSteel

`class MaterialSoulforgedSteel : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialSoulforgedSteel(matName: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
