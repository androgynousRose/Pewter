[Pewter](../../index.md) / [com.ejektaflex.pewter.mods.betterwithmods](../index.md) / [MaterialHellfire](./index.md)

# MaterialHellfire

`class MaterialHellfire : `[`MaterialDSL`](../../com.ejektaflex.pewter.api.core.materials/-material-d-s-l/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `MaterialHellfire(matName: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
