[Pewter](../../index.md) / [com.ejektaflex.pewter.modules](../index.md) / [ModuleThaumcraft](./index.md)

# ModuleThaumcraft

`class ModuleThaumcraft : `[`PewterModule`](../../com.ejektaflex.pewter.api.core/-pewter-module/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ModuleThaumcraft()` |
