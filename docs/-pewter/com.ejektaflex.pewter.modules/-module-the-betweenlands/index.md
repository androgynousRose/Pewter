[Pewter](../../index.md) / [com.ejektaflex.pewter.modules](../index.md) / [ModuleTheBetweenlands](./index.md)

# ModuleTheBetweenlands

`class ModuleTheBetweenlands : `[`PewterModule`](../../com.ejektaflex.pewter.api.core/-pewter-module/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ModuleTheBetweenlands()` |
